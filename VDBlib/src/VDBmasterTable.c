...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"hydrography",   "hydrography_discharge_subbasin",               "Hydrography-Discharge-Subbasin",               "Discharge Subbasin",                    VDBdiscrete,   VDBnotApplicable, VDBnotApplicable, VDBnotApplicable},
