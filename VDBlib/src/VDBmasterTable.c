...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"hydrography",   "hydrography_discharge_subbasin",               "Hydrography-River-Discharge-Subbasin",         "Discharge Subbasin",                       VDBpoint,      VDBnotApplicable, VDBnotApplicable, VDBnotApplicable},
