...
static VDBmasterTable_t _VDBmasterTable2 [] = {
        ...
        {"hydrography",   "discharge",                         "RiverDischarge",                  "River Discharge",                       VDBcontinuous, VDBblue,          VDBavg},
        {"hydrography",   "discharge_gauge",                   "RiverDischargeGauge",             "River Discharge Gauge",                       VDBpoint,      VDBnotApplicable, VDBnotApplicable},
        ...
        {"river",         "river_slope",                       "Slope",                           "River Slope",                           VDBcontinuous, VDBelevation,     VDBavg},
