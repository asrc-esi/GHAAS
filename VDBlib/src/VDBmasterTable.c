...
static VDBmasterTable_t _VDBmasterTable3 [] = {
        ...
        {"hydrography",   "hydrography_discharge",                        "Hydrography-River-Discharge",                  "Discharge",                             VDBcontinuous, VDBblue,          VDBavg,           VDBsamplingPoint},
        {"hydrography",   "hydrography_discharge_gauge",                  "Hydrography-River-Discharge-Gauge",            "Discharge Gauge",                       VDBpoint,      VDBnotApplicable, VDBnotApplicable, VDBnotApplicable},
        ...
        {"station",       "station_discharge",                            "Station-Discharge",                            "Discharge Gauge",                       VDBpoint,      VDBnotApplicable, VDBnotApplicable, VDBnotApplicable},
